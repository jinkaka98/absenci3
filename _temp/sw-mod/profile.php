            ...
            <div class="card">
                <div class="card-body">
                    <form id="update-profile">
                        ...
                        <hr>
                             <button style="display:none;"type="submit" class="btn btn-danger mr-1 btn-lg btn-block btn-profile">Simpan</button> 
            ...
            <div class="card">
                <div class="card-body">
                    <form id="update-password">
                        ...
                        <hr>
                        <button style="display:none;" type="submit" class="btn btn-danger mr-1 btn-lg btn-block">Simpan</button>
                    </form>
