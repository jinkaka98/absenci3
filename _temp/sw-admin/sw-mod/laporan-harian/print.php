...
if(isset($_GET['month']) OR isset($_GET['year'])){
      ...
      if(isset($_GET['month']) OR isset($_GET['year'])){
        ...
        <table class="customTable"
          ...
          <tbody>';
           $query ="SELECT employees.employees_code,employees.id,employees.employees_name,shift.shift_id,position.position_id,position.position_name,shift.shift_name FROM employees INNER JOIN position ON employees.position_id = position.position_id INNER JOIN shift ON employees.shift_id = shift.shift_id  $filter_employees ORDER BY id ASC";
